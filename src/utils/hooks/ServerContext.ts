...
export const [getMenus, setMenus] = ServerContext<IMenu[] | null>(null);
export const [getSidePosts, setSidePosts] = ServerContext<IPostCard[] | null>(null);
export const [getSiteoptions, setSiteoptions] = ServerContext<ISiteOptions | null>(null);
